...
This repository contains a collection of small Python projects I built while learning and practising programming. Each project is stored in its own folder and includes a self-contained script.
...
Run any project by opening its folder and executing the Python file.

Purpose of This Repository - To demonstrate:
- Basic Python problem-solving skills
